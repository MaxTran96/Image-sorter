...
public class ImageDownloader {
    public static void main(String[] args) {
    	...
    	Packet[] packet = PacketReceiver.receivePackets();
    	PacketComparator comparator = new PacketComparator();
        // TODO: Sort the packets by calling one of your methods
    	GenericSorter.mergeSort(packet, comparator);
        String imageOutputFilename = "finalImage2.jpg";
        // TODO: Make the correct call to render the images
        PacketRenderer.renderImage(packet, imageOutputFilename);
    }
